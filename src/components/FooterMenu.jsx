  ...
  const sections = [
    {
      ...
      items: [
        ...
        { href: 'https://www.ankr.com/app-chains/', text: 'AppChains' },
    ...
    },
    {
        ...
        items: [
          ...
          { href: 'https://www.ankr.com/staking-crypto/binance-bnb/', text: 'Binance Smart Chain' },
          { href: 'https://www.ankr.com/staking-crypto/polkadot-dot/', text: 'Polkadot' },
    ...
    },
    {
        ...
        items: [
          ...
          { href: 'https://grants.ankr.com/', text: 'Grants & Referrals' },
