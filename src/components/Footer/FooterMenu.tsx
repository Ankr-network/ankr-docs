  ...
  const sections: Section[] = [
    {
      ...
      items: [
        {
          href: 'https://www.ankr.com/remote-procedure-call/',
          text: 'Web3 API',
        },
        { href: 'https://www.ankr.com/staking-crypto/', text: 'Staking' },
        {
          href: 'https://www.ankr.com/rollup-as-a-service-raas/',
        ...
        {
          href: 'https://www.ankr.com/docs/chainscanner/block-explorer/',
          text: 'Block Explorer',
        },
        { href: 'https://www.ankr.com/about-network/', text: 'Ankr Network' },
        {
          href: 'https://www.ankr.com/about-network/token/',
          text: 'Ankr Token',
        },
      ],
    },
    {
      ...
      items: [
        {
          href: 'https://www.ankr.com/remote-procedure-call/polygon-matic/',
          text: 'Polygon',
        },
    ...
    },
    {
      ...
      items: [
        {
          href: 'https://www.ankr.com/staking-crypto/ethereum-eth/',
          text: 'Ethereum',
        },
        {
          href: 'https://www.ankr.com/staking-crypto/polygon-matic/',
          text: 'Polygon',
        },
        {
          href: 'https://www.ankr.com/staking-crypto/avalanche-avax/',
          text: 'Avalanche',
        },
        {
          href: 'https://www.ankr.com/staking-crypto/binance-bnb/',
          text: 'BSC',
        },
        {
          href: 'https://www.ankr.com/staking-crypto/fantom-ftm/',
          text: 'Fantom',
        },
    ...
    },
    {
      ...
      items: [
        ...
        {
          href: 'https://www.ankr.com/case-studies/meta-apes/',
          text: 'Meta Apes',
        },
        {
          href: 'https://www.ankr.com/case-studies/mantle/',
          text: 'Mantle Network',
        },
        {
          href: 'https://www.ankr.com/case-studies/',
    ...
    },
    {
      ...
      items: [
        ...
        {
          href: 'https://ankr.hashnode.dev/',
          text: 'Tutorials',
          rel: 'noreferrer',
        },
        {
          href: 'https://github.com/Ankr-network',
          text: 'Github',
          rel: 'noreferrer',
        },
        {
          href: 'https://www.ankr.com/ankr-whitepaper-2.0.pdf',
          text: 'Ankr Whitepaper 2.0',
        },
    ...
    },
    {
      ...
      items: [
        ...
        {
          href: 'https://www.youtube.com/c/AnkrOfficial',
          text: 'YouTube',
          icon: Youtube,
          className: 'flex',
          rel: 'noreferrer',
