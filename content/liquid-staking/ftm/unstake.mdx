...
2. Locate the ankrFTM (ex-aFTMc) box and click the **-** icon to unstake.
   <img src="/docs/staking/liquid-staking/ftm/click-minus-icon.jpg" alt="Click the minus icon" className="responsive-pic" width="500" />
3. Enter the desired amount to unstake and click **Unstake**.
   <img src="/docs/staking/liquid-staking/ftm/enter-amount-click-unstake.jpg" alt="Click Unstake" className="responsive-pic" width="350" />
6. Confirm the unstaking transaction in MetaMask.
   <img src="/docs/staking/liquid-staking/ftm/confirm-unstaking-transaction.jpg" alt="Confirm transaction in MetaMask" className="responsive-pic" width="250" />
7. On the next **Unstake in progress page**, click **Go to dashboard**.
   <img src="/docs/staking/liquid-staking/ftm/unstake-in-progress-go-to-dashboard.jpg" alt="Click Go to dashboard" className="responsive-pic" width="450" />
