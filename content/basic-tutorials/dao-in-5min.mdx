...
<img src="/docs/tutorials/reXHIQX1T.png" alt="Hello" className="responsive-pic" width="700" />
...
<img src="/docs/tutorials/h9Fg7K8Dh.png" alt="Hello" className="responsive-pic" width="700" />
...
<img src="/docs/tutorials/M9ZL-fipA.png" alt="Hello" className="responsive-pic" width="700" />
...
<img src="/docs/tutorials/2hCqeOQGP.png" alt="Hello" className="responsive-pic" width="700" />
...
<img src="/docs/tutorials/lgcDc4BRP.png" alt="Hello" className="responsive-pic" width="700" />

- Once you set up the name from the DAO, click "Next: Configure template".

### Configure Voting  

<img src="/docs/tutorials/gglyCR3CN.png" alt="Hello" className="responsive-pic" width="700" />
...
<img src="/docs/tutorials/tk-syH5ds.png" alt="Hello" className="responsive-pic" width="700" />
...
<img src="/docs/tutorials/g0JSY-t1w.png" alt="Hello" className="responsive-pic" width="700" />

With that, you should be presented with a screen similar to this:

<img src="/docs/tutorials/C-QwyWtIR.png" alt="Hello" className="responsive-pic" width="700" />

### First Proposal, First Vote

Click on get started, and let us create our very first proposal to begin the voting process.

<img src="/docs/tutorials/v9DCmgk0W.png" alt="Hello" className="responsive-pic" width="700" />
...
<img src="/docs/tutorials/CTxYhHkWB.png" alt="Hello" className="responsive-pic" width="700" />
...
<img src="/docs/tutorials/3uIf2XTyL.png" alt="Hello" className="responsive-pic" width="700" />
