...
> Start using Advanced API on the [Web3 API platform](https://www.ankr.com/rpc/advanced-api/).
...
<img src="/docs/build/aapi.png" className="responsive-pic" width="800" />
...
Currently, Advanced API supports querying the following chains using their aliases:
...
[_Token API Methods_](/advanced-api/token-methods/) serve to request token-related data across multiple chains:
  ...
  * [`ankr_getTokenPriceHistory`](/advanced-api/token-methods/#ankr_gettokenpricehistory) — retrieves the historical price of the token specified.
