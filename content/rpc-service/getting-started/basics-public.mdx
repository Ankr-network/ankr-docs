...
<img src="/docs/build/chain-select.png" alt="Chain selection" className="responsive-pic" width="600" />
3. In the **Chain** opened, select a network (**Mainnet**/**Testnet**) required for your project.
<img src="/docs/build/network-select.png" alt="Network selection" className="responsive-pic" width="600" />
4. In the **HTTPS Endpoint** field, copy the URL and paste it into your project's library or config file.
<img src="/docs/build/copy-endpoint-public.png" alt="Use public endpoint" className="responsive-pic" width="600" />
