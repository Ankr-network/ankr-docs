...
**Premium-only methods**:
  ...
  * [`debug_traceBlockByHash`](/rpc-service/chains/chains-api/blast/#debug_traceblockbyhash) — traces the execution of all transactions within a block specified by hash.
  * [`debug_traceBlockByNumber`](/rpc-service/chains/chains-api/blast/#debug_traceblockbynumber) — traces the execution of all transactions within a block specified by number.
  * [`debug_traceBlock`](/rpc-service/chains/chains-api/blast/#debug_traceblock) — traces the execution of all transactions within a block.
