...
**Premium-only methods (zkSync Era Sepolia Testnet)**:

  * [`debug_traceBlockByHash`](/rpc-service/chains/chains-api/zksync-era/#debug_traceblockbyhash) — traces the execution of all transactions within a block specified by hash.
  * [`debug_traceBlockByNumber`](/rpc-service/chains/chains-api/zksync-era/#debug_traceblockbynumber) — traces the execution of all transactions within a block specified by number.
  * [`debug_traceBlock`](/rpc-service/chains/chains-api/zksync-era/#debug_traceblock) — traces the execution of all transactions within a block.
...
```shell
curl -X POST https://rpc.ankr.com/zksync_era_sepolia/{your_token} \
-H 'Content-Type: application/json' \
-d '{
    "jsonrpc": "2.0",
