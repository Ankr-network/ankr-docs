...
8. Click **Switch network** to confirm switching.
   <img src="/docs/staking/connect-wallet/confirm-switching-networks-gnosis.jpg" alt="Confirm switching networks" className="responsive-pic" width="250" />
...
2. In the **Delegated staking** section, click **Stake** under **GNO**.
   <img src="/docs/staking/delegated-staking/gnosis/gno-staking-box.jpg" alt="Locate the GNO box" className="responsive-pic" width="400" />
3. Choose a Node Provider (currently only Ankr; more providers in future releases).
   <img src="/docs/staking/delegated-staking/gnosis/choose-node-provider.jpg" alt="Choose a Node Provider" className="responsive-pic" width="400" />
5. Enter the desired amount to stake and click **Approve** to allow Ankr Staking smart contracts to stake for you.
   <img src="/docs/staking/delegated-staking/gnosis/enter-amount-click-approve.jpg" alt="Enter an amount and click Approve" className="responsive-pic" width="400" />
6. Set a spending cap in MetaMask.
   <img src="/docs/staking/delegated-staking/gnosis/set-spending-cap.jpg" alt="Set a spending cap" className="responsive-pic" width="250" />
7. Confirm your approval in MetaMask.
   <img src="/docs/staking/delegated-staking/gnosis/confirm-approval.jpg" alt="Confirm your approval" className="responsive-pic" width="250" />
8. Click **Stake** to send your delegated stake to the chosen Node Provider..
   <img src="/docs/staking/delegated-staking/gnosis/click-stake.jpg" alt="Click Stake" className="responsive-pic" width="400" />
9. Confirm the staking transaction in MetaMask.
   <img src="/docs/staking/delegated-staking/gnosis/confirm-staking-transaction.jpg" alt="Confirm staking transaction" className="responsive-pic" width="250" />
10. Click **Go to dashboard** to see the added token. You may need to wait a little for the transaction to finalize and **Dashboard** to automatically update.
    <img src="/docs/staking/delegated-staking/gnosis/click-go-to-dashboard.jpg" alt="Click Go to dashboard" className="responsive-pic" width="450" />
