...
<img src="/docs/node-snapshot/available-snapshots.png" alt="Available snapshots" className="responsive-pic" width="600" />
  2. Pay through the Storj portal to receive the access token required to download a snapshot.
<img src="/docs/node-snapshot/storj-payment.png" alt="Payment" className="responsive-pic" width="600" />
