...
<img src="/docs/tutorials/UNqYn6bc9.png" alt="Hello" className="responsive-pic" width="700" />
...
<img src="/docs/tutorials/y6E7komKa.png" alt="Hello" className="responsive-pic" width="700" />
...
<img src="/docs/tutorials/3It48bzyT.png" alt="Hello" className="responsive-pic" width="700" />
...
<img src="/docs/tutorials/P_UDtYrtQ.png" alt="Hello" className="responsive-pic" width="700" />
...
<img src="/docs/tutorials/8EboJFvPh.png" alt="Hello" className="responsive-pic" width="700" />


You can also view the creation of the table on Etherscan by clicking on the Rinkeby Address. 

<img src="/docs/tutorials/H_pSA-jt8.png" alt="Hello" className="responsive-pic" width="700" />
...
<img src="/docs/tutorials/tQJPuqZEk.png" alt="Hello" className="responsive-pic" width="700" />

- Click `Insert Record` and you should be able to see the newly created entry in the table as well on Etherscan

<img src="/docs/tutorials/3T-kOW4Qo.png" alt="Hello" className="responsive-pic" width="700" />

<img src="/docs/tutorials/0LDDqDp29.png" alt="Hello" className="responsive-pic" width="700" />
...
<img src="/docs/tutorials/oW7LllAql.png" alt="Hello" className="responsive-pic" width="700" />
...
<img src="/docs/tutorials/alf4GWDYr.png" alt="Hello" className="responsive-pic" width="700" />
...
<img src="/docs/tutorials/jAycEzShd.png" alt="Hello" className="responsive-pic" width="700" />
...
<img src="/docs/tutorials/y_66Lg_c-.png" alt="Hello" className="responsive-pic" width="700" />


- Once done, click on `Deploy` and wait for the trigger to go live. 

<img src="/docs/tutorials/0wjtSCjq_.png" alt="Hello" className="responsive-pic" width="700" />
...
<img src="/docs/tutorials/mQnxtVQyU.png" alt="Hello" className="responsive-pic" width="700" />
...
<img src="/docs/tutorials/t-St-1K7v.png" alt="Hello" className="responsive-pic" width="700" />
...
<img src="/docs/tutorials/EctSeXYJp.png" alt="Hello" className="responsive-pic" width="700" />
...
<img src="/docs/tutorials/-IiXqBA1H.png" alt="Hello" className="responsive-pic" width="700" />
