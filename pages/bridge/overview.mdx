...
Ankr Bridge supports the following native Ankr Liquid Tokens to be transferred between these networks:

| Ankr Liquid Tokens | Networks                |
|:-------------------|-------------------------|
| ankrBNB            | BNB Smart Chain — opBNB |
| ankrPOL            | Ethereum Mainnet — BNB Smart Chain — Polygon Mainnet — Polygon zkEVM |
| ankrETH            | Ethereum Mainnet — BNB Smart Chain — Avalanche — Fantom Opera — Polygon zkEVM — Arbitrum One — OP Mainnet — Mode — Blast — Scroll — Linea |

## Audit details

Ankr Bridge has undergone external audit by Beosin Blockchain Security. 
To learn more, view the [detailed audit report](/pdf/ankr_bridge_security_audit.pdf).
