...
3. Locate the "unsupported old version" of ankrETH and click **Switch to new**.<br />
   <img src="/docs/staking/extra/switch-old-aethc-to-new/dashboard-init.jpg" alt="Staking dashboard with old ankrETH" class="responsive-pic" width="1000" />
   <Callout type="info">
...
4. Confirm the switching transaction in your wallet. <br />
   <img src="/docs/staking/extra/switch-old-aethc-to-new/confirm-switching.jpg" alt="Confirm switching" class="responsive-pic" width="300" />
5. After confirming the transaction, wait for it to finalize. <br />
   <img src="/docs/staking/extra/switch-old-aethc-to-new/switching-pending.jpg" alt="Switching in progress" class="responsive-pic" width="550" />
6. When the transaction is finalized and switching is successful, click **Go to dashboard** to see the new ankrETH.
   ...
   <img src="/docs/staking/extra/switch-old-aethc-to-new/switching-success.jpg" alt="Successful switching" class="responsive-pic" width="550" />
