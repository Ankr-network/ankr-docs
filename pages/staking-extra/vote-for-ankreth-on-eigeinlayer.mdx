...
2. Choose a network to vote on.
   <Callout type="tip">
       ...
       <img src="/docs/staking/extra/mnt-in-metmask.jpg" class="responsive-pic" width="250" />
   </Callout>
...
4. Choose your wallet and proceed to connect it. Remember that you need to connect an address where you had ankrETH specifically on Oct 27, 2023.
   <img src="/docs/staking/extra/choose-wallet-for-voting.jpg" class="responsive-pic" width="600" />
...
8. Wait till the "votes are deploying..." popup disappears and confirm the voting transaction in your wallet.
   <img src="/docs/staking/extra/confirm-voting-transaction.jpg" class="responsive-pic" width="250" />
