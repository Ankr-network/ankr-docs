...
* Synapse — the KYC provider. Synapse requests and stores real user data.
* AnkrVerify Wallet Service (backend + frontend) — a service for generating proofs for policies.
* AnkrVerify smart contract — a contract deployed on a specific chain; stores links to the IPFS proofs.
