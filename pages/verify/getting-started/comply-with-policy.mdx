...
1. Visit the [Verified Policies](https://oauth-proxy.ankr.com/oauth2/sign_in?rd=https://www-stage.ankr.com/verify/consumer/?section=policies&status=active) tab in your Ankr Verify account and click **Request Policy**.
...
3. Sign your request in MetaMask and return to the [Verified Policies](https://oauth-proxy.ankr.com/oauth2/sign_in?rd=https://www-stage.ankr.com/verify/consumer/?section=policies&status=active) to see the policies you've complied with.
