...
**Want to become a vendor?**<br/>
    Visit our [vendor page](https://www.ankr.com/verifying/vendor/) and hit the **Talk to an Expert** button.
</Callout>
...
To do this, integrate with our on-chain smart contract. [Learn how to integrate with our contract](/verify/integrating/check-user-compliance/).
