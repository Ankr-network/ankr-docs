...
<img src="/docs/tutorials/Tkwmg4J.png" alt="Hello" className="responsive-pic" />
...
<img src="/docs/tutorials/93uxHCp.png" alt="Hello" className="responsive-pic" />
...
<img src="/docs/tutorials/J1HASEhYT.png" alt="Hello" className="responsive-pic" />
...
<img src="/docs/tutorials/DyW7Xgk.png" alt="Hello" className="responsive-pic" />
...
<img src="/docs/tutorials/yxqNdmc.png" alt="Hello" className="responsive-pic" />
...
<img src="/docs/tutorials/MvlfbmT.png" alt="Hello" className="responsive-pic" />
...
<img src="/docs/tutorials/MTYuQoc.png" alt="Hello" className="responsive-pic" />
...
<img src="/docs/tutorials/p7sZQMX.png" alt="Hello" className="responsive-pic" />
...
<img src="/docs/tutorials/AJevJA3.png" alt="Hello" className="responsive-pic" />
...
<img src="/docs/tutorials/6hOp28F.png" alt="Hello" className="responsive-pic" />
...
> 1657242017
```
<img src="/docs/tutorials/MwS58Kl.png" alt="Hello" className="responsive-pic" />



Check if the NFT was successfully rented out by calling `userOf` function for the token with token ID 1.
<img src="/docs/tutorials/O7mbSIT.png" alt="Hello" className="responsive-pic" />
...
<img src="/docs/tutorials/VfdFwjU.png" alt="Hello" className="responsive-pic" />
