...
Ankr does not take any technical service fee for Fantom Liquid Staking.   

 Remember that when unstaking, the user pays a burn fee that depends on the current liquidity and unstaked amount.
