...
### What is the minimum amount of BNB I can stake and unstake?

The minimum amount is 0.1 BNB. You must also count in the gas fee on top for sending the transaction.
