...
3. Choose **Standard unstake**, enter the desired amount, and click **Approve** to allow Ankr Staking smart contracts to access this amount.
   <img src="/docs/staking/liquid-staking/bnb/flash-unstake-enter-amount-click-approve.jpg" alt="Enter an amount and click Approve" class="responsive-pic" width="400" />
4. Confirm the amount or set another apending cap for this and future interactions with Ankr's BNB Liquid Staking contracts. Then click **Next**.
   <img src="/docs/staking/liquid-staking/bnb/flash-unstake-set-spending-cap.jpg" alt="Set cap and click Next" class="responsive-pic" width="300" />   
5. Confirm your approval by clicking **Approve**.
   <img src="/docs/staking/liquid-staking/bnb/flash-unstake-approve-spending-cap.jpg" alt="Confirm approval" class="responsive-pic" width="300" />
6. Click **Unstake** to unstake the desired amount.
   <img src="/docs/staking/liquid-staking/bnb/flash-unstake-click-unstake.jpg" alt="Click Unstake" class="responsive-pic" width="400" />
...
8. On the next **Unstake in progress page**, click **Go to dashboard**.
   <img src="/docs/staking/liquid-staking/bnb/flash-unstake-unstake-in-progress-go-to-dashboard.jpg" alt="Click Go to dashboard" class="responsive-pic" width="550" />
