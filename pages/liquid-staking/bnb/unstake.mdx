...
2. Locate the ankrBNB box and click the **-** icon to unstake.
   <img src="/docs/staking/liquid-staking/bnb/click-minus-icon.jpg" alt="Click the minus icon" class="responsive-pic" width="600" />
3. Choose **Standard unstake**, enter the desired amount, and click **Approve** to allow Ankr Staking smart contracts to access this amount.
   <img src="/docs/staking/liquid-staking/bnb/flash-unstake-enter-amount-click-approve.jpg" alt="Enter an amount and click Approve" class="responsive-pic" width="350" />
4. Confirm the amount or set another appending cap for this and future interactions with Ankr's BNB Liquid Staking contracts. Then click **Next**.
   <img src="/docs/staking/liquid-staking/bnb/flash-unstake-set-spending-cap.jpg" alt="Set cap and click Next" class="responsive-pic" width="250" />
5. Confirm your approval by clicking **Approve**.
   <img src="/docs/staking/liquid-staking/bnb/flash-unstake-approve-spending-cap.jpg" alt="Confirm approval" class="responsive-pic" width="250" />
6. Click **Unstake** to unstake the desired amount.
   <img src="/docs/staking/liquid-staking/bnb/flash-unstake-click-unstake.jpg" alt="Click Unstake" class="responsive-pic" width="350" />
7. Confirm the unstaking transaction in MetaMask.
   <img src="/docs/staking/liquid-staking/bnb/confirm-unstaking-transaction.jpg" alt="Confirm transaction in MetaMask" class="responsive-pic" width="250" />
8. On the next **Unstake in progress page**, click **Go to dashboard**.
   <img src="/docs/staking/liquid-staking/bnb/flash-unstake-unstake-in-progress-go-to-dashboard.jpg" alt="Click Go to dashboard" class="responsive-pic" width="450" />
...
2. Locate the ankrBNB box and click the **-** icon to unstake.
   <img src="/docs/staking/liquid-staking/bnb/click-minus-icon.jpg" alt="Click the minus icon" class="responsive-pic" width="600" />
3. Choose **Standard unstake**, enter the desired amount, and click **Approve** to allow Ankr Staking smart contracts to access this amount.
   <img src="/docs/staking/liquid-staking/bnb/enter-amount-click-approve.jpg" alt="Enter an amount and click Approve" class="responsive-pic" width="350" />
4. Confirm your approval in MetaMask.
   <img src="/docs/staking/liquid-staking/bnb/confirm-approval.jpg" alt="Confirm your approval" class="responsive-pic" width="250" />
5. Click **Unstake** to unstake the desired amount.
   <img src="/docs/staking/liquid-staking/bnb/click-unstake.jpg" alt="Click Unstake" class="responsive-pic" width="350" />
6. Confirm the unstaking transaction in MetaMask.
   <img src="/docs/staking/liquid-staking/bnb/confirm-unstaking-transaction.jpg" alt="Confirm transaction in MetaMask" class="responsive-pic" width="250" />
7. On the next **Unstake in progress page**, click **Go to dashboard**.
   <img src="/docs/staking/liquid-staking/bnb/unstake-in-progress-go-to-dashboard.jpg" alt="Click Go to dashboard" class="responsive-pic" width="450" />
