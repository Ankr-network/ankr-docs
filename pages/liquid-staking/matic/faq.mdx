...
Also, remember that when unstaking on Ethereum, the user pays a technical service fee of 0.025 ETH, and when unstaking on Polygon, the user pays a technical service fee of 0.5% from the unstaking amount.
