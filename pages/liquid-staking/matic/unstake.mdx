...
2. Locate the ankrMATIC (ex-aMATICc) box and click the **-** icon to unstake.
   <img src="/docs/staking/liquid-staking/matic/click-minus-icon.jpg" alt="Click the minus icon" class="responsive-pic" width="600" />
3. Enter the desired amount to unstake and click **Unstake**.
   <img src="/docs/staking/liquid-staking/matic/enter-amount-and-click-unstake.jpg" alt="Click unstake" class="responsive-pic" width="400" />
6. Confirm the unstaking transaction in MetaMask.
   <img src="/docs/staking/liquid-staking/matic/confirm-unstaking-transaction.jpg" alt="Confirm transaction in MetaMask" class="responsive-pic" width="250" />
7. On the next **Unstake in progress page**, click **Go to dashboard**.
   <img src="/docs/staking/liquid-staking/matic/unstake-in-progress-go-to-dashboard.jpg" alt="Click Go to dashboard" class="responsive-pic" width="450" />
