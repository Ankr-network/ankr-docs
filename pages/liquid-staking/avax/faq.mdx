...
Yes — there is a [user guide](https://www.ankr.com/docs/liquid-staking/avax/stake/).
...
You will receive your staked AVAX once the nearest validator completes its validation period. This process can take anywhere from 0 to 35 days, depending on the timing of your unstaking request in relation to the validation period.
