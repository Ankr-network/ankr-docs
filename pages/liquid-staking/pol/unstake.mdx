...
2. In the **ankrPOL** tile, click the **—** button to unstake.
   <img src="/docs/staking/liquid-staking/pol/click-minus-icon.jpg" class="responsive-pic" width="600" />
3. Enter the unstake amount and click **Unstake**.
   <img src="/docs/staking/liquid-staking/pol/enter-amount-and-click-unstake.jpg" class="responsive-pic" width="400" />
4. Confirm the unstaking transaction in MetaMask.
   <img src="/docs/staking/liquid-staking/pol/confirm-unstaking-transaction.jpg" class="responsive-pic" width="250" />
5. In the next **Unstake in progress** dialog, click **Go to dashboard**.
   <img src="/docs/staking/liquid-staking/pol/unstake-in-progress-go-to-dashboard.jpg" class="responsive-pic" width="450" />
