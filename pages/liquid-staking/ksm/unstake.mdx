...
## Unstake KSM
<Callout type="info">
As redeeming of aKSMb (unstaking KSM) is done in the Ethereum network, ensure you have a small amount of ETH to pay the gas fee for your unstaking transaction.
</Callout>
