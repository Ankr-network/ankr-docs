...
<img src="/docs/build/ui-schema.png" alt="UI Schema" className="responsive-pic" width="600" />
...
<img src="/docs/build/aapi-gs.png" alt="Advanced API pane" className="responsive-pic" width="700" />
...
In terms of the things you can do in the **Advanced API** pane, it comes to the following options based on whether you've already added AAPI to a project or not:
...
<img src="/docs/build/aapi-scenarios.png" alt="Advanced API pane" className="responsive-pic" width="700" />
...
<img src="/docs/build/getting-started/stats.png" className="responsive-pic" width="700" />
...
<br/>
<img src="/docs/build/getting-started/pltfrm-stngs.png" alt="UI Schema" className="responsive-pic" width="700" />
...
<img src="/docs/build/getting-started/billing-pane.png" className="responsive-pic" width="700" />
