...
`Interface schema` —> `Sign in` —> `Deposit funds` —> `Use private endpoints`
  ...
  * **[Interface schema](/rpc-service/getting-started/overview/#interface-schema)**: surely, it's always helpful to orient yourself in a new environment. Hardcore users can skip this step and proceed to the following one.
...
<img src="/docs/build/sign-in-method.png" alt="Authentication method" class="responsive-pic" width="500" />
  ...
  * [**Google account**](/rpc-service/getting-started/basics-premium/#via-google-account) — sign in with your Google account. This option provides for the credit card payment flow only, though you can connect your wallet anytime to use the Web3 wallet payment flow.
  * [**Web3 wallet**](/rpc-service/getting-started/basics-premium/#via-web3-wallet) — connect your wallet to sign in. This option enables using both Web3 wallet and credit card payment flows.
...
Depending on the [sign-in](/rpc-service/getting-started/basics-premium/#sign-in) option selected, you can deposit funds the following way:
  ...
  * [Web3 wallet flow](/rpc-service/getting-started/basics-premium/#web3-wallet-flow)
...
Prerequisites:
  ...
  * [Sign in](/rpc-service/getting-started/basics-premium/#via-web3-wallet)
