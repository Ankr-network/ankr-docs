...
<Callout type="tip">
**Coming soon**. Available for [Premium](/rpc-service/service-plans/#service-plans-comparison) users only.
</Callout>

*Projects* is a feature that provides the means to use several unique tokens in private endpoints of a single user account and secure your project's blockchain interaction by specifying a particular smart contract to communicate through. That might help with project structuring, interaction security, as well as with traffic distribution for the most demanding throughput.
...
<img src="/docs/build/getting-started/add-project.png" class="responsive-pic" width="600" />
    ...
    * **White list** — here you enter the smart contract address used for project communication.
