...
[//]: # (  * [`/walletsolidity/getdeferredtransactionbyid`]&#40;/rpc-service/chains/chains-api/tron/#walletsoliditygetdeferredtransactionbyid&#41; — retrieves the deferred transaction information by transaction ID.)
[//]: # (  * [`/walletsolidity/getdeferredtransactioninfobyid`]&#40;/rpc-service/chains/chains-api/tron/#walletsoliditygetdeferredtransactioninfobyid&#41; — retrieves the deferred transaction fee and block height by transaction ID.)
[//]: # (  * [`/walletsolidity/getmerkletreevoucherinfo`]&#40;/rpc-service/chains/chains-api/tron/#walletsoliditygetmerkletreevoucherinfo&#41; — retrieves a merkle tree information of a note.)
[//]: # (  * [`/walletsolidity/scannotebyivk`]&#40;/rpc-service/chains/chains-api/tron/#walletsolidityscannotebyivk&#41; — retrieves all the notes by ivk.)
[//]: # (  * [`/walletsolidity/scanandmarknotebyivk`]&#40;/rpc-service/chains/chains-api/tron/#walletsolidityscanandmarknotebyivk&#41; — retrieves all the notes with spent status by ivk.)
[//]: # (  * [`/walletsolidity/scannotebyovk`]&#40;/rpc-service/chains/chains-api/tron/#walletsolidityscannotebyovk&#41; — retrieves all the notes by ovk.)
[//]: # (  * [`/walletsolidity/isspend`]&#40;/rpc-service/chains/chains-api/tron/#walletsolidityisspend&#41; — checks whether a note is spent or not.)
[//]: # (  * [`/walletsolidity/scanshieldedtrc20notesbyivk`]&#40;/rpc-service/chains/chains-api/tron/#walletsolidityscanshieldedtrc20notesbyivk&#41; — scans the shielded TRC-20 notes by ivk and marks their status of whether spent or not.)
...
[//]: # (  * [`wallet/getdeferredtransactionbyid`]&#40;/rpc-service/chains/chains-api/tron/#walletgetdeferredtransactionbyid&#41; — retrieves the deferred transaction information by transaction ID.)
[//]: # (  * [`wallet/canceldeferredtransactionbyid`]&#40;/rpc-service/chains/chains-api/tron/#walletcanceldeferredtransactionbyid&#41; — retrieves a deferred transaction by transaction ID.)
[//]: # (  * [`wallet/getdeferredtransactioninfobyid`]&#40;/rpc-service/chains/chains-api/tron/#walletgetdeferredtransactioninfobyid&#41; — retrieves the deferred transaction fee and block height by transaction ID.)
...
[//]: # (  * [`wallet/scannotebyivk`]&#40;/rpc-service/chains/chains-api/tron/#walletscannotebyivk&#41; — retrieves all the notes by ivk.)
[//]: # (  * [`wallet/scanandmarknotebyivk`]&#40;/rpc-service/chains/chains-api/tron/#walletscanandmarknotebyivk&#41; — retrieves all the notes with spent status by ivk.)
[//]: # (  * [`wallet/scannotebyovk`]&#40;/rpc-service/chains/chains-api/tron/#walletscannotebyovk&#41; — retrieves all the notes by ovk.)
  * [`wallet/getrcm`](/rpc-service/chains/chains-api/tron/#walletgetrcm) — retrieves a random commitment trapdoor.

[//]: # (  * [`wallet/getmerkletreevoucherinfo`]&#40;/rpc-service/chains/chains-api/tron/#walletgetmerkletreevoucherinfo&#41; — retrieves a merkle tree information of a note.)
[//]: # (  * [`wallet/isspend`]&#40;/rpc-service/chains/chains-api/tron/#walletisspend&#41; — checks whether a note is spent or not.)
[//]: # (  * [`wallet/createshieldnullifier`]&#40;/rpc-service/chains/chains-api/tron/#walletcreateshieldnullifier&#41; — creates a shielded nullifier.)
[//]: # (  * [`wallet/getshieldtransactionhash`]&#40;/rpc-service/chains/chains-api/tron/#walletgetshieldtransactionhash&#41; — retrieves a shielded transaction hash.)
[//]: # (  * [`wallet/gettriggerinputforshieldedtrc20contract`]&#40;/rpc-service/chains/chains-api/tron/#walletgettriggerinputforshieldedtrc20contract&#41; — retrieves the trigger input data of shielded TRC-20 contract for the shielded TRC-20 parameters without spending authority signature.)
...
```shell
curl -X GET 'https://rpc.ankr.com/http/tron/walletsolidity/listwitnesses'
```
...
[//]: # (curl -X POST 'https://rpc.ankr.com/http/tron/walletsolidity/getdeferredtransactionbyid' \)
...
[//]: # (curl -X POST 'https://rpc.ankr.com/http/tron/walletsolidity/getdeferredtransactioninfobyid' \)
...
[//]: # (curl -X POST 'https://rpc.ankr.com/http/tron/walletsolidity/getmerkletreevoucherinfo' \)
...
[//]: # (curl -X POST 'https://rpc.ankr.com/http/tron/walletsolidity/scannotebyivk' \)
...
[//]: # (curl -X POST 'https://rpc.ankr.com/http/tron/walletsolidity/scanandmarknotebyivk' \)
...
[//]: # (curl -X POST 'https://rpc.ankr.com/http/tron/walletsolidity/scannotebyovk' \)
...
[//]: # (curl -X POST 'https://rpc.ankr.com/http/tron/walletsolidity/isspend' \)
...
[//]: # (curl -X POST 'https://rpc.ankr.com/http/tron/walletsolidity/scanshieldedtrc20notesbyivk' \)
...
[//]: # (curl -X POST 'https://rpc.ankr.com/http/tron/wallet/getdeferredtransactionbyid' \)
...
[//]: # (curl -X POST 'https://rpc.ankr.com/http/tron/wallet/canceldeferredtransactionbyid' \)
...
[//]: # (curl -X POST 'https://rpc.ankr.com/http/tron/wallet/getdeferredtransactioninfobyid' \)
...
[//]: # (curl -X POST 'https://rpc.ankr.com/http/tron/wallet/scannotebyivk' \)
...
[//]: # (curl -X POST 'https://rpc.ankr.com/http/tron/wallet/scanandmarknotebyivk' \)
...
[//]: # (curl -X POST 'https://rpc.ankr.com/http/tron/wallet/scannotebyovk' \)
...
[//]: # (curl -X POST 'https://rpc.ankr.com/http/tron/wallet/getmerkletreevoucherinfo' \)
...
[//]: # (curl -X POST 'https://rpc.ankr.com/http/tron/wallet/isspend' \)
...
[//]: # (curl -X POST 'https://rpc.ankr.com/http/tron/wallet/createshieldnullifier' \)
...
[//]: # (curl -X POST 'https://rpc.ankr.com/http/tron/wallet/getshieldtransactionhash' \)
