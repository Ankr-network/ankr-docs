...
**Beacon**:
  ...
  * [`GET /eth/v1/beacon/genesis`](/rpc-service/chains/chains-api/beacon/#get-ethv1beacongenesis) — retrieves the details of the chain's genesis.
  * [`GET /eth/v1/beacon/states/{state_id}/root`](/rpc-service/chains/chains-api/beacon/#get-ethv1beaconstatesstate_idroot) — retrieves the state SSZ HashTreeRoot.
  * [`GET /eth/v1/beacon/states/{state_id}/fork`](/rpc-service/chains/chains-api/beacon/#get-ethv1beaconstatesstate_idfork) — retrieves the Fork object for a requested state.
  * [`GET /eth/v1/beacon/states/{state_id}/finality_checkpoints`](/rpc-service/chains/chains-api/beacon/#get-ethv1beaconstatesstate_idfinality_checkpoints) — retrieves state finality checkpoints.
  * [`GET /eth/v1/beacon/states/{state_id}/validators`](/rpc-service/chains/chains-api/beacon/#get-ethv1beaconstatesstate_idvalidators) — retrieves validators from state.
  * [`GET /eth/v1/beacon/states/{state_id}/validators/{validator_id}`](/rpc-service/chains/chains-api/beacon/#get-ethv1beaconstatesstate_idvalidatorsvalidator_id) — retrieves the validator from state by ID.
  * [`GET /eth/v1/beacon/states/{state_id}/validator_balances`](/rpc-service/chains/chains-api/beacon/#get-ethv1beaconstatesstate_idvalidator_balances) — retrieves validator balances from state.
  * [`GET /eth/v1/beacon/states/{state_id}/committees`](/rpc-service/chains/chains-api/beacon/#get-ethv1beaconstatesstate_idcommittees) — retrieves all committees for a state.
  * [`GET /eth/v1/beacon/states/{state_id}/sync_committees`](/rpc-service/chains/chains-api/beacon/#get-ethv1beaconstatesstate_idsync_committees) — retrieves sync committees for a state.
  * [`GET /eth/v1/beacon/headers`](/rpc-service/chains/chains-api/beacon/#get-ethv1beaconheaders) — retrieves block headers.
  * [`GET /eth/v1/beacon/headers/{block_id}`](/rpc-service/chains/chains-api/beacon/#get-ethv1beaconheadersblock_id) — retrieves a block header.
  * [`POST /eth/v1/beacon/blocks`](/rpc-service/chains/chains-api/beacon/#post-ethv1beaconblocks) — publishes a signed block.
  * [`POST /eth/v1/beacon/blinded_blocks`](/rpc-service/chains/chains-api/beacon/#post-ethv1beaconblinded_blocks) — publishes a signed block.
  * [`GET /eth/v2/beacon/blocks/{block_id}`](/rpc-service/chains/chains-api/beacon/#get-ethv2beaconblocksblock_id) — retrieves a block.
  * [`GET /eth/v1/beacon/blocks/{block_id}/root`](/rpc-service/chains/chains-api/beacon/#get-ethv1beaconblocksblock_idroot) — retrieves a block root.
  * [`GET /eth/v1/beacon/blocks/{block_id}/attestations`](/rpc-service/chains/chains-api/beacon/#get-ethv1beaconblocksblock_idattestations) — retrieves block attestations.
  * [`GET /eth/v1/beacon/pool/attestations`](/rpc-service/chains/chains-api/beacon/#get-ethv1beaconpoolattestations) — retrieves attestations from the operations pool.
  * [`POST /eth/v1/beacon/pool/attestations`](/rpc-service/chains/chains-api/beacon/#post-ethv1beaconpoolattestations) — submits attestation objects to the node.
  * [`GET /eth/v1/beacon/pool/attester_slashings`](/rpc-service/chains/chains-api/beacon/#get-ethv1beaconpoolattester_slashings) — retrieves attester slashings from the operations pool.
  * [`POST /eth/v1/beacon/pool/attester_slashings`](/rpc-service/chains/chains-api/beacon/#post-ethv1beaconpoolattester_slashings) — submits the AttesterSlashing object to the node's pool.
  * [`GET /eth/v1/beacon/pool/proposer_slashings`](/rpc-service/chains/chains-api/beacon/#get-ethv1beaconpoolproposer_slashings) — retrieves proposer slashings from the operations pool.
  * [`POST /eth/v1/beacon/pool/proposer_slashings`](/rpc-service/chains/chains-api/beacon/#post-ethv1beaconpoolproposer_slashings) — submits the ProposerSlashing object to the node's pool.
  * [`POST /eth/v1/beacon/pool/sync_committees`](/rpc-service/chains/chains-api/beacon/#post-ethv1beaconpoolsync_committees) — submits sync committee signatures to the node.
  * [`GET /eth/v1/beacon/pool/voluntary_exits`](/rpc-service/chains/chains-api/beacon/#get-ethv1beaconpoolvoluntary_exits) — retrieves SignedVoluntaryExit from the operations pool.
  * [`POST /eth/v1/beacon/pool/voluntary_exits`](/rpc-service/chains/chains-api/beacon/#post-ethv1beaconpoolvoluntary_exits) — submits the SignedVoluntaryExit object to the node's pool.


**Config**:

  * [`GET /eth/v1/config/fork_schedule`](/rpc-service/chains/chains-api/beacon/#get-ethv1configfork_schedule) — retrieves scheduled upcoming forks.
  * [`GET /eth/v1/config/spec`](/rpc-service/chains/chains-api/beacon/#get-ethv1configspec) — retrieves spec parameters.
  * [`GET /eth/v1/config/deposit_contract`](/rpc-service/chains/chains-api/beacon/#get-ethv1configdeposit_contract) — retrieves a deposit contract address.

**Debug**:

  * [`GET /eth/v2/debug/beacon/states/{state_id}`](/rpc-service/chains/chains-api/beacon/#get-ethv2debugbeaconstatesstate_id) — retrieves the full BeaconState object.
  * [`GET /eth/v2/debug/beacon/heads`](/rpc-service/chains/chains-api/beacon/#get-ethv2debugbeaconheads) — retrieves fork choice leaves.

**Events**:

  * [`GET /eth/v1/events`](/rpc-service/chains/chains-api/beacon/#get-ethv1events) — subscribes to Beacon node events.

**Node**:

  * [`GET /eth/v1/node/peers`](/rpc-service/chains/chains-api/beacon/#get-ethv1nodepeers) — retrieves node network peers.
  * [`GET /eth/v1/node/peers/{peer_id}`](/rpc-service/chains/chains-api/beacon/#get-ethv1nodepeerspeer_id) — retrieves a peer.
  * [`GET /eth/v1/node/peer_count`](/rpc-service/chains/chains-api/beacon/#get-ethv1nodepeer_count) — retrieves peer count.
  * [`GET /eth/v1/node/version`](/rpc-service/chains/chains-api/beacon/#get-ethv1nodeversion) — retrieves a version string of the running Beacon node.
  * [`GET /eth/v1/node/syncing`](/rpc-service/chains/chains-api/beacon/#get-ethv1nodesyncing) — retrieves a node syncing status.
  * [`GET /eth/v1/node/health`](/rpc-service/chains/chains-api/beacon/#get-ethv1nodehealth) — retrieves health check.

**Validator**:

  * [`POST /eth/v1/validator/duties/attester/{epoch}`](/rpc-service/chains/chains-api/beacon/#post-ethv1validatordutiesattesterepoch) — retrieves attester duties.
  * [`GET /eth/v1/validator/duties/proposer/{epoch}`](/rpc-service/chains/chains-api/beacon/#get-ethv1validatordutiesproposerepoch) — retrieves block proposer duties.
  * [`POST /eth/v1/validator/duties/sync/{epoch}`](/rpc-service/chains/chains-api/beacon/#post-ethv1validatordutiessyncepoch) — retrieves sync committee duties.
  * [`GET /eth/v1/validator/blocks/{slot}`](/rpc-service/chains/chains-api/beacon/#get-ethv1validatorblocksslot) — produces a new block, without signature.
  * [`GET /eth/v1/validator/blinded_blocks/{slot}`](/rpc-service/chains/chains-api/beacon/#get-ethv1validatorblinded_blocksslot) — produces a new block, without signature.
  * [`GET /eth/v1/validator/attestation_data`](/rpc-service/chains/chains-api/beacon/#get-ethv1validatorattestation_data) — produces attestation data.
  * [`GET /eth/v1/validator/aggregate_attestation`](/rpc-service/chains/chains-api/beacon/#get-ethv1validatoraggregate_attestation) — retrieves aggregated attestation.
  * [`POST /eth/v1/validator/aggregate_and_proofs`](/rpc-service/chains/chains-api/beacon/#post-ethv1validatoraggregate_and_proofs) — publishes multiple aggregate and proofs.
  * [`POST /eth/v1/validator/beacon_committee_subscriptions`](/rpc-service/chains/chains-api/beacon/#post-ethv1validatorbeacon_committee_subscriptions) — signals the Beacon node to prepare for a committee subnet.
  * [`POST /eth/v1/validator/sync_committee_subscriptions`](/rpc-service/chains/chains-api/beacon/#post-ethv1validatorsync_committee_subscriptions) — subscribes to sync committee subnets.
  * [`GET /eth/v1/validator/sync_committee_contribution`](/rpc-service/chains/chains-api/beacon/#get-ethv1validatorsync_committee_contribution) — produces a sync committee contribution.
  * [`POST /eth/v1/validator/contribution_and_proofs`](/rpc-service/chains/chains-api/beacon/#post-ethv1validatorcontribution_and_proofs) — publishes multiple contribution and proofs.
  * [`POST /eth/v1/validator/prepare_beacon_proposer`](/rpc-service/chains/chains-api/beacon/#post-ethv1validatorprepare_beacon_proposer) — provides the Beacon node with proposals for the given validators.
  * [`POST /eth/v1/validator/register_validator`](/rpc-service/chains/chains-api/beacon/#post-ethv1validatorregister_validator) — provides the Beacon node with registrations for the given validators to the external builder network.

**ValidatorRequiredApi**:

  * [`GET /eth/v1/beacon/genesis`](/rpc-service/chains/chains-api/beacon/#get-ethv1beacongenesis-1) — retrieves details of the chain's genesis.
  * [`GET /eth/v1/beacon/states/{state_id}/fork`](/rpc-service/chains/chains-api/beacon/#get-ethv1beaconstatesstate_idfork-1) — retrieves the Fork object for a requested state.
  * [`GET /eth/v1/beacon/states/{state_id}/validators/{validator_id}`](/rpc-service/chains/chains-api/beacon/#get-ethv1beaconstatesstate_idvalidatorsvalidator_id-1) — retrieves the validator from state by ID.
  * [`POST /eth/v1/beacon/blocks`](/rpc-service/chains/chains-api/beacon/#post-ethv1beaconblocks-1) — publishes a signed block.
  * [`POST /eth/v1/beacon/blinded_blocks`](/rpc-service/chains/chains-api/beacon/#post-ethv1beaconblinded_blocks-1) — publishes a signed block.
  * [`POST /eth/v1/beacon/pool/attestations`](/rpc-service/chains/chains-api/beacon/#post-ethv1beaconpoolattestations-1) — submits attestation objects to the node.
  * [`POST /eth/v1/beacon/pool/sync_committees`](/rpc-service/chains/chains-api/beacon/#post-ethv1beaconpoolsync_committees-1) — submits sync committee signatures to the node.
  * [`GET /eth/v1/node/syncing`](/rpc-service/chains/chains-api/beacon/#get-ethv1nodesyncing-1) — retrieves a node syncing status.
  * [`GET /eth/v1/config/spec`](/rpc-service/chains/chains-api/beacon/#get-ethv1configspec-1) — retrieves spec parameters.
  * [`POST /eth/v1/validator/duties/attester/{epoch}`](/rpc-service/chains/chains-api/beacon/#post-ethv1validatordutiesattesterepoch-1) — retrieves attester duties.
  * [`GET /eth/v1/validator/duties/proposer/{epoch}`](/rpc-service/chains/chains-api/beacon/#get-ethv1validatordutiesproposerepoch-1) — retrieves block proposer duties.
  * [`POST /eth/v1/validator/duties/sync/{epoch}`](/rpc-service/chains/chains-api/beacon/#post-ethv1validatordutiessyncepoch-1) — retrieves sync committee duties.
  * [`GET /eth/v1/validator/blocks/{slot}`](/rpc-service/chains/chains-api/beacon/#get-ethv1validatorblocksslot-1) — produces a new block, without signature.
  * [`GET /eth/v1/validator/blinded_blocks/{slot}`](/rpc-service/chains/chains-api/beacon/#get-ethv1validatorblinded_blocksslot-1) — produces a new block, without signature.
  * [`GET /eth/v1/validator/attestation_data`](/rpc-service/chains/chains-api/beacon/#get-ethv1validatorattestation_data-1) — produces attestation data.
  * [`GET /eth/v1/validator/aggregate_attestation`](/rpc-service/chains/chains-api/beacon/#get-ethv1validatoraggregate_attestation-1) — retrieves aggregated attestation.
  * [`POST /eth/v1/validator/aggregate_and_proofs`](/rpc-service/chains/chains-api/beacon/#post-ethv1validatoraggregate_and_proofs-1) — publishes multiple aggregate and proofs.
  * [`POST /eth/v1/validator/beacon_committee_subscriptions`](/rpc-service/chains/chains-api/beacon/#post-ethv1validatorbeacon_committee_subscriptions-1) — signals the Beacon node to prepare for a committee subnet.
  * [`POST /eth/v1/validator/sync_committee_subscriptions`](/rpc-service/chains/chains-api/beacon/#post-ethv1validatorsync_committee_subscriptions-1) — subscribes to sync committee subnets.
  * [`GET /eth/v1/validator/sync_committee_contribution`](/rpc-service/chains/chains-api/beacon/#get-ethv1validatorsync_committee_contribution-1) — produces a sync committee contribution.
  * [`POST /eth/v1/validator/contribution_and_proofs`](/rpc-service/chains/chains-api/beacon/#post-ethv1validatorcontribution_and_proofs-1) — publishes multiple contribution and proofs.
  * [`POST /eth/v1/validator/prepare_beacon_proposer`](/rpc-service/chains/chains-api/beacon/#post-ethv1validatorprepare_beacon_proposer-1) — provides the Beacon node with proposals for the given validators.
  * [`GET /eth/v1/events`](/rpc-service/chains/chains-api/beacon/#get-ethv1events-1) — subscribes to Beacon node events.
