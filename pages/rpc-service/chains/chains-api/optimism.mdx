...
For Optimism, we support the following methods:
  ...
  * [EVM JSON-RPC methods](/rpc-service/chains/chains-api/optimism/#evm-json-rpc-methods)
  * [Flashblocks methods](/rpc-service/chains/chains-api/optimism/#flashblocks-methods)
