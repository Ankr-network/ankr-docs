...
**Validator**:
  ...
  * [`GET /eth/v1/validator/blocks/{slot}`](/rpc-service/chains/chains-api/eth-beacon/#get-ethv1validatorblocksslot) — produces a new block, without signature.
  * [`GET /eth/v1/validator/blinded_blocks/{slot}`](/rpc-service/chains/chains-api/eth-beacon/#get-ethv1validatorblinded_blocksslot) — produces a new block, without signature.
...
**ValidatorRequiredApi**:
  ...
  * [`GET /eth/v1/validator/blocks/{slot}`](/rpc-service/chains/chains-api/eth-beacon/#get-ethv1validatorblocksslot-1) — produces a new block, without signature.
  * [`GET /eth/v1/validator/blinded_blocks/{slot}`](/rpc-service/chains/chains-api/eth-beacon/#get-ethv1validatorblinded_blocksslot-1) — produces a new block, without signature.
