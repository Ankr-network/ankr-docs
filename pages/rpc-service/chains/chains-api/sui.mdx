...
## Methods supported
  ...
  * [`suix_subscribeEvent`](/rpc-service/chains/chains-api/sui/#suix_subscribeevent) — subscribes to a stream of Sui event.
  * [`suix_subscribeTransaction`](/rpc-service/chains/chains-api/sui/#suix_subscribetransaction) — subscribes to a stream of Sui transaction effects.
