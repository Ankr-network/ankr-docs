...
Movement API uses the REST interface for querying, responses come in [JSON format](https://www.json.org/json-en.html).

## Methods supported

**Accounts**:

  * [Get account](/rpc-service/chains/chains-api/movement/#get-account) — retrieves the authentication key and the sequence number for an account address.
  * [Get account resources](/rpc-service/chains/chains-api/movement/#get-account-resources) — retrieves all account resources for a given account and a specific ledger version.
  * [Get account modules](/rpc-service/chains/chains-api/movement/#get-account-modules) — retrieves all account modules' bytecode for a given account at a specific ledger version.
  * [Get account resource](/rpc-service/chains/chains-api/movement/#get-account-resource) — retrieves an individual resource from a given account and at a specific ledger version.
  * [Get account module](/rpc-service/chains/chains-api/movement/#get-account-module) — retrieves an individual module from a given account and at a specific ledger version.

**Blocks**:

  * [Get blocks by height](/rpc-service/chains/chains-api/movement/#get-blocks-by-height) — retrieves the transactions in a block and the corresponding block information.
  * [Get blocks by version](/rpc-service/chains/chains-api/movement/#get-blocks-by-version) — retrieves the transactions in a block and the corresponding block information by version in the block.

**Events**:

  * [Get events by creation number](/rpc-service/chains/chains-api/movement/#get-events-by-creation-number) — retrieves events by creation number.
  * [Get events by event handle](/rpc-service/chains/chains-api/movement/#get-events-by-event-handle) — retrieves events by event handle.

**General**:

  * [Get ledger info](/rpc-service/chains/chains-api/movement/#get-ledger-info) — retrieves the latest ledger information.

**Table**:

  * [Get table item](/rpc-service/chains/chains-api/movement/#get-table-item) — retrieves a table item.
  * [Get raw table item](/rpc-service/chains/chains-api/movement/#get-raw-table-item) — retrieves a raw table item.

**Transactions**:

  * [Get transactions](/rpc-service/chains/chains-api/movement/#get-transactions) — retrieves on-chain committed transactions.
  * [Submit transaction](/rpc-service/chains/chains-api/movement/#submit-transaction) — submits a transaction in JSON or BCS.
  * [Get transaction by hash](/rpc-service/chains/chains-api/movement/#get-transaction-by-hash) — retrieves a transaction by its hash.
  * [Get transaction by version](/rpc-service/chains/chains-api/movement/#get-transaction-by-version) — retrieves a transaction by a given version.
  * [Get account transactions](/rpc-service/chains/chains-api/movement/#get-account-transactions) — retrieves on-chain committed transactions from an account.
  * [Submit batch transactions](/rpc-service/chains/chains-api/movement/#submit-batch-transactions) — submits multiple transactions.
  * [Simulate transaction](/rpc-service/chains/chains-api/movement/#simulate-transaction) — simulates transaction submission.
  * [Encode submission](/rpc-service/chains/chains-api/movement/#encode-submission) — accepts an EncodeSubmissionRequest, which internally is a UserTransactionRequestInner (and optionally secondary signers) encoded as JSON, validates the request format, and then returns that request encoded in BCS.
  * [Estimate gas price](/rpc-service/chains/chains-api/movement/#estimate-gas-price) — estimates gas price.

**View**:

  * [Execute view function of a module](/rpc-service/chains/chains-api/movement/#execute-view-function-of-a-module) — executes the Move function with the given parameters and return its execution result.
...
> **GET `https://rpc.ankr.com/http/movement/v1/accounts/{address}`**
...
#### Parameters
  ...
  * `address` (string; hex; path; required): an address of account with or without a `0x` prefix.<br/>
    Example: `0x3f7399a0d3d646ce94ee0badf16c4c3f3c656fe3a5e142e83b5ebc011aa8b3d`
...
> **GET `https://rpc.ankr.com/http/movement_mainnet/v1/accounts/{address}/resources`**
...
> **GET `https://rpc.ankr.com/http/movement_mainnet/v1/accounts/{address}/modules`**
...
> **GET `https://rpc.ankr.com/http/movement_mainnet/v1/accounts/{address}/resource/{resource_type}`**
...
> **GET `https://rpc.ankr.com/http/movement_mainnet/v1/accounts/{address}/module/{module_name}`**
...
> **GET `https://rpc.ankr.com/http/movement_mainnet/v1/blocks/by_height/{block_height}`**
...
> **GET `https://rpc.ankr.com/http/movement_mainnet/v1/blocks/by_version/{version}`**
...
> **GET `https://rpc.ankr.com/http/movement_mainnet/v1/accounts/{address}/events/{creation_number}`**
...
> **GET `https://rpc.ankr.com/http/movement_mainnet/v1/accounts/{address}/events/{event_handle}/{field_name}`**
...
> **GET `https://rpc.ankr.com/http/movement_mainnet/v1/`**
...
> **POST `https://rpc.ankr.com/http/movement_mainnet/v1/tables/{table_handle}/item`**
...
```shell
curl -X POST https://rpc.ankr.com/http/movement_mainnet/v1/tables/{table_handle}/item \
-H 'Content-Type: application/json' \
-d '{
      "key_type": "string",
      "value_type": "string",
...
> **POST `https://rpc.ankr.com/http/movement_mainnet/v1/tables/{table_handle}/raw_item`**
...
> **GET `https://rpc.ankr.com/http/movement_mainnet/v1/transactions`**
...
To retrieve a pending transaction, use [Get transactions by hash](/rpc-service/chains/chains-api/movement/#get-transaction-by-hash).
...
> **POST `https://rpc.ankr.com/http/movement_mainnet/v1/transactions`**
...
```shell
curl -X POST https://rpc.ankr.com/http/movement_mainnet/v1/transactions \
-H 'Content-Type: application/json'
-d '{
  "sender": "0x88fbd33f54e1126269769780feb24480428179f552e2313fbe571b72e62a1ca1 ",
  "sequence_number": "32425224034",
...
> **GET `https://rpc.ankr.com/http/movement_mainnet/v1/transactions/by_hash/{txn_hash}`**
...
> **GET `https://rpc.ankr.com/http/movement_mainnet/v1/transactions/by_version/{txn_version}`**
...
> **GET `https://rpc.ankr.com/http/movement_mainnet/v1/accounts/{address}/transactions`**
...
To retrieve a pending transaction, use [Get transaction by hash](/rpc-service/chains/chains-api/movement/#get-transaction-by-hash).
...
```shell
curl -X POST https://rpc.ankr.com/http/movement_mainnet/v1/transactions/batch \
-H 'Content-Type: application/json'
-d '[
  {
    "sender": "0x88fbd33f54e1126269769780feb24480428179f552e2313fbe571b72e62a1ca1 ",
...
```shell
curl -X POST https://rpc.ankr.com/http/movement_mainnet/v1/transactions/simulate \
-H 'Content-Type: application/json' \
-d '{
  "sender": "0x88fbd33f54e1126269769780feb24480428179f552e2313fbe571b72e62a1ca1 ",
  "sequence_number": "32425224034",
...
```shell
curl -X POST https://rpc.ankr.com/http/movement_mainnet/v1/transactions/encode_submission \
-H 'Content-Type: application/json' \
-d '{
  "sender": "0x88fbd33f54e1126269769780feb24480428179f552e2313fbe571b72e62a1ca1 ",
  "sequence_number": "32425224034",
...
```shell
curl -X POST https://rpc.ankr.com/http/movement_mainnet/v1/view \
-H 'Content-Type: application/json' \
-d '{
  "function": "0x1::aptos_coin::transfer",
  "type_arguments": [
