...
Rollux API supports the following requests:
  ...
  * [EVM methods](/rpc-service/chains/chains-api/rollux/#evm-methods) — Rollux testnet.
  * [Op-node methods](/rpc-service/chains/chains-api/rollux/#op-node-methods) — Rollux Op-node Testnet.
...
```shell
curl -X POST https://rpc.ankr.com/rollux_opnode_testnet \
-H 'Content-Type: application/json' \
-d '{
      "jsonrpc": "2.0",
