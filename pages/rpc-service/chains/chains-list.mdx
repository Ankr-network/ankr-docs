...
https://rpc.ankr.com/premium-http/aptos/2d0c3a3a5ae6977edba0d1416c3fa21bd8273591dabd5f21156542eed96e167b/v1
...
func main() {
    const url = "https://rpc.ankr.com/fantom"  // url string
...
def test_block_number(self):
    url = 'https://rpc.ankr.com/fantom'  # url string
