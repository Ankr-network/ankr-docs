...
| [Arbitrum](/rpc-service/chains/chains-list/#arbitrum)                 | [Chiliz](/rpc-service/chains/chains-list/#chiliz)               | [Harmony](/rpc-service/chains/chains-list/#harmony)            | [Metis](/rpc-service/chains/chains-list/#metis)       | [Polygon zkEVM](/rpc-service/chains/chains-list/#polygon-zkevm)   | [TRON](/rpc-service/chains/chains-list/#tron)             |
| [Arbitrum Nova](/rpc-service/chains/chains-list/#arbitrum-nova)       | [Ethereum](/rpc-service/chains/chains-list/#ethereum)           | [HECO Chain](/rpc-service/chains/chains-list/#huobi-eco-chain) | [Moonbeam](/rpc-service/chains/chains-list/#moonbeam) | [Rollux](/rpc-service/chains/chains-list/#rollux)                 | [ZetaChain](/rpc-service/chains/chains-list/#zetachain)   |
| [Avalanche](/rpc-service/chains/chains-list/#avalanche)               | [Ethereum Beacon](/rpc-service/chains/chains-list/#eth-beacon)  | [Horizen](/rpc-service/chains/chains-list/#horizen)            | [NEAR](/rpc-service/chains/chains-list/#near)         | [Scroll](/rpc-service/chains/chains-list/#scroll)                 | [zkSync Era](/rpc-service/chains/chains-list/#zksync-era) |
| [Base](/rpc-service/chains/chains-list/#base)                         | [Fantom](/rpc-service/chains/chains-list/#fantom)               | [IoTeX](/rpc-service/chains/chains-list/#iotex)                | [Nervos](/rpc-service/chains/chains-list/#nervos)     | [Secret Network](/rpc-service/chains/chains-list/#secret-network) |                                                           |
...
> Horizen API is available on [RPC Service](https://www.ankr.com/rpc/horizen).

Horizen is a fully EVM-compatible sidechain and smart contracting platform. Horizen’s cross-chain protocol, Zendoo, is designed for developers to build blockchains and applications that solve today’s real-world problems with the flexibility to capture tomorrow’s opportunities.

Horizen claims to be the first decentralized and fully customizable sidechain protocol in the industry that solves the biggest problems in applying blockchain solutions to real-world use cases.

Horizen is build with the following ideas in mind:
...
Official quick links: [Website](https://www.horizen.io/), [Docs](https://docs.horizen.io/en/latest/), [GitHub](https://github.com/horizenofficial)
...
For Horizen, we support blockchain interaction via all the [applicable methods](/rpc-service/chains/chains-api/horizen/) except for those listed as unsupported.
