...
For Base, we support blockchain interaction via all the applicable methods except for those listed as unsupported:
  ...
  * [EVM JSON-RPC methods](/rpc-service/chains/chains-api/base/#evm-json-rpc-methods)
  * [Flashblocks methods](/rpc-service/chains/chains-api/base/#flashblocks-methods)
