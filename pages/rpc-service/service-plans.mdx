...
*Deal* is a subscription-based charging model for the Premium Plan services. It is a recurring `500USD` — `3,000USD` payment at a `20% discount` that provides you with `6 Billion` API credits that you can spend within a month to call both *Node* and *Advanced APIs* for all the chains we support.
