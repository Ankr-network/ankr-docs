...
Our [RPC Service](https://www.ankr.com/rpc/) platform has the following solutions to offer:
  ...
  * *[Chains API](/rpc-service/getting-started/intro/#chains-api)* — the endpoints that enable your Web3 projects to start interacting with an extensive list of [supported blockchains](/rpc-service/chains/chains-list/), give access to viewing the usage statistics for the data queried, and provide the means for RPC API methods testing.
