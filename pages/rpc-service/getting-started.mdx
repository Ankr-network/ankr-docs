...
The platform has the following functionality to offer:
  ...
  * *JSON-RPC API* — the endpoints (either [public](/rpc-service/getting-started/#use-public-endpoints) or [private](/rpc-service/getting-started/#use-private-endpoints)) to provide your project with blockchain interaction.
  ...
  * *RPC methods checker* — a tool for test-querying RPC methods before using them.

## Interface schema
<br/>

<img src="/docs/build/ui-schema.jpg" alt="UI Schema" class="responsive-pic" width="800" />
...
<img src="/docs/build/use-endp-public.jpg" alt="Use public endpoint" class="responsive-pic" width="800" />
