...
<Callout>
_Token API_ is a part of Advanced APIs' collection of methods that can be added as the add-on premium feature to the AppChains package.
</Callout>
    ...
    "result": {
        "transfers": [
            ...
            },
            {
                ...
                "blockchain": "bas_bombchain_testnet",
