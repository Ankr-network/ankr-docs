...
Another example is Polygon Supernets — a partner that takes from AppChains what it misses, e.g., trusted validators for its validators set.  
...
You do that appby lying Gaming SDK, another piece that AppChains can offer from Ankr's infrastructure.
