...
2. Click **Connect wallet**.
   <img src="/docs/automation/click-connect-wallet.jpg" alt="Click the connect wallet button" className="responsive-pic" width="500" />
3. Choose a wallet.
   <img src="/docs/automation/choose-wallet-to-connect.jpg" alt="Choose a wallet" className="responsive-pic" width="500" />
4. Connect the wallet.
   <img src="/docs/automation/connect-wallet.jpg" alt="Connect the wallet" className="responsive-pic" width="250" />
5. Successful wallet connection is indicated in the top-right corner, on the dashboard.
   <img src="/docs/automation/successful-wallet-connection.jpg" alt="Successful wallet connection" className="responsive-pic" width="250" />
...
1. Visit [Ankr Automation Dashboard](https://www.ankr.com/automate/dashboard/).
2. Click **Create Task**.
   <img src="/docs/automation/click-create-task.jpg" alt="Click Create Task" className="responsive-pic" width="500" />
3. Enter Task details: a name, address of a [compatible contract](/automation/create-compatible-contracts/#example-contract), [**custom data**](/automation/create-compatible-contracts/#parameters), and gas limit. When done, click **Continue**.<br/>
   <img src="/docs/automation/enter-custom-logic-task-details.jpg" alt="Enter task details" className="responsive-pic" width="400" />
4. Read the information message about the function check and click **Continue**.
   <img src="/docs/automation/check-function-execution.jpg" alt="Set up the schedule" className="responsive-pic" width="400" />
5. Top up your Ankr Automation account: click **Deposit** and add some BNB for the gas fees, then click **Continue**.
   <img src="/docs/automation/set-up-payment.jpg" alt="Enter task details" className="responsive-pic" width="400" />
6. Click **Create Task** to finish the process. 
   <img src="/docs/automation/finish-creating-task.jpg" alt="Finish creating the Task" className="responsive-pic" width="400" />
7. Confirm in MetMask deployment of your automation to the Ankr Automation registrar. You may be also asked to confirm a CRON wrapping transaction, so that makes up 2 txs in total.
   <img src="/docs/automation/confirm-deployment-of-automation.jpg" alt="Confirm deployment of automation" className="responsive-pic" width="250" />
8. You'll be redirected to [Ankr Automation Dashboard](https://www.ankr.com/automate/dashboard/) to view and manage created Tasks.
   <img src="/docs/automation/successfully-created-tasks.jpg" alt="Check created task on Ankr Automation Dashboard" className="responsive-pic" width="600" />
