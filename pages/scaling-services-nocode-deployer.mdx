...
To deploy a rollup using a Testnet network, follow these steps:
  ...
  3. On the **Essentials** tab, select the following rollup parameters, and then click **Next**:
      * **Stack**:
        * **Instant**: [Arbitrum Orbit](/scaling-services-overview/#arbitrum-orbit), [OP Stack](/scaling-services-overview/#op-stack) — deploy instantly upon completing all the steps.
        * **Assisted** (no label): [Polygon CDK](/scaling-services-overview/#polygon-cdk), [ZK Stack](/scaling-services-overview/#zk-stack) — provide your rollup requirements and schedule a meeting with our specialists to deploy according to the specification.
