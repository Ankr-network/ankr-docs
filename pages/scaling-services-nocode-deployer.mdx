...
To define an SPE deployment configuration, follow these steps:
  ...
  3. On the **Essentials** tab, select the following SPE parameters, and then click **Next**:
      * **Stack**: SVM.
     <img src="/docs/scale/stack-solana.png" class="responsive-pic" width="700" />

      * **Network**: Select either a **Testnet** or production-ready **Mainnet** option for your SPE:
     <img src="/docs/scale/network-solana.png" class="responsive-pic" width="700" />
     ...
     <img src="/docs/scale/network-access-solana.png" class="responsive-pic" width="700" />
  4. On the **Configuration** tab, specify the following parameters, and then click **Next**:
      * **Chain Name**
     <img src="/docs/scale/chain-name-solana.png" class="responsive-pic" width="500" />
  ...
  5. On the **Infrastructure** tab, check the components included in your package, and then click **Confirm**.
<img src="/docs/scale/infra-package-solana.png" class="responsive-pic" width="700" />
...
<img src="/docs/scale/summary-solana.png" class="responsive-pic" width="350" />
