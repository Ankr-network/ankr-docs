...
**Mainnet**:
  ...
  * `Avalanche`, `Arbitrum`, `Base`, `BNB Smart Chain`, `Ethereum`, `Fantom`, `Flare`, `Gnosis`, `Linea`, `Optimism`, `Polygon`, `Polygon zkEVM`, `Rollux`, `Scroll`, `Stellar`, `Story`, `Syscoin`, `Telos`, `Xai`, `X Layer`.

**Testnet**:

  * `Avalanche Fuji`, `Base Sepolia`, `Ethereum Holesky`, `Ethereum Sepolia`, `Optimism Testnet`, `Polygon Amoy`, `Story Testnet`.
