...
**Mainnets**:
  ...
  * `Avalanche`, `Arbitrum`, `Base`, `BNB Smart Chain`, `Ethereum`, `Fantom`, `Optimism`, `Polygon`, `Polygon zkEVM`, `Rollux`, `Syscoin`, `zkSync Era`.

**Testnets**:

  * `Avalanche Fuji`, `Ethereum Goerli`, `Optimism Testnet`, `Polygon Mumbai`.
