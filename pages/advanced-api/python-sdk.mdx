...
[Sign in](/rpc-service/getting-started/basics-premium/#sign-in) to the [RPC Service](https://www.ankr.com/rpc/) platform, get your individual endpoint from the [Advanced APIs](https://www.ankr.com/rpc/advanced-api) pane, and provide it to the `AnkrWeb3` class.
