...
* `params` (object): the data object containing request body parameters:
  ...
  * `blockchain` (string; required): either of the supported chains (`eth`, `bsc`, `arbitrum`, `avalanche`, `fantom`, `polygon`, `polygon_zkevm`, `syscoin`, `optimism`, `eth_goerli`, `polygon_mumbai`, `avalanche_fuji`).
