...
* `params` (object): the data object containing request body parameters:
  ...
  * `blockchain` (string): a chain or a combination of chains to query:
    * Single chain: `arbitrum`, `avalanche`, `base`, `bsc`, `eth`, `fantom`, `flare`, `gnosis`, `optimism`, `polygon`, `polygon_zkevm`, `rollux`, `syscoin`, `avalanche_fuji`, `eth_goerli`, `optimism_testnet`, `polygon_mumbai`.
    * Chains combination: `[arbitrum, avalanche, base, bsc, eth, fantom, flare, gnosis, optimism, polygon, polygon_zkevm, rollux, syscoin, avalanche_fuji, eth_goerli, optimism_testnet, polygon_mumbai]`.
...
* `result` (object): the data object containing a list of NFT assets and their metadata:
  * `blockchain` (string; required): one of the supported chains (`arbitrum`, `avalanche`, `base`, `bsc`, `eth`, `fantom`, `flare`, `gnosis`, `optimism`, `polygon`, `polygon_zkevm`, `rollux`, `syscoin`, `avalanche_fuji`, `eth_goerli`, `optimism_testnet`, `polygon_mumbai`).
...
* `params` (object): the data object containing request body parameters.
  ...
  * `blockchain` (string; required): either of the supported chains (`arbitrum`, `avalanche`, `base`, `bsc`, `eth`, `fantom`, `flare`, `gnosis`, `optimism`, `polygon`, `polygon_zkevm`, `rollux`, `syscoin`, `avalanche_fuji`, `eth_goerli`, `optimism_testnet`, `polygon_mumbai`).
...
* `params` (object): the data object containing request body parameters.
  ...
  * `blockchain` (string; required): either of the supported blockchains (`arbitrum`, `avalanche`, `base`, `bsc`, `eth`, `fantom`, `flare`, `gnosis`, `optimism`, `polygon`, `polygon_zkevm`, `rollux`, `syscoin`, `avalanche_fuji`, `eth_goerli`, `optimism_testnet`, `polygon_mumbai`).
  * `contractAddress` (string): a contract address of the NFT collection; supports the Ethereum Name Service (ENS).
...
* `params` (object): the data object containing request body parameters.
  ...
  * `blockchain` (array of strings): either of the supported blockchains (`arbitrum`, `avalanche`, `base`, `bsc`, `eth`, `fantom`, `flare`, `gnosis`, `optimism`, `polygon`, `polygon_zkevm`, `rollux`, `syscoin`, `avalanche_fuji`, `eth_goerli`, `optimism_testnet`, `polygon_mumbai`).
