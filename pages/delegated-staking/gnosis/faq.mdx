...
The unstaking functionality has been enabled on the Gnosis Chain. We're currently working on implementing it in Ankr Staking and expect to release it in a few weeks.
