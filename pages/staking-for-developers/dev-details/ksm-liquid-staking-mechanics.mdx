...
Ankr takes 2% fee from the staking reward.
...
4. Recalculates the aKSMb share — the aKSMb exchange ratio. The share is an analog of ankrETH (which historically was aETH), but for Kusama. For example, user has 1 share, but due to ratio change, aKSMb balance grows daily.
