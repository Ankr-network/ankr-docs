...
## Fees
Staking fees:
* On Ethereum — 5% fee from the staking reward.
* On Polygon — 5% fee from the staking reward.

Unstaking fees: 
* On Ethereum — 0.025 ETH.
* On Polygon — 0.5% from the unstaked amount.
...
### On Polygon
User swaps their assets via the Ankr's swap pool on Polygon for ankrMATIC.
