...
If you need more details on cumulative prices and TWAP oracles, refer to the [Uniswap oracles documentation](https://docs.uniswap.org/concepts/protocol/oracle).
...
<img src="/docs/staking/oracles/pancakeswap-oracle-peek-query.png" alt="response for a price query" className="responsive-pic" width="600" />
