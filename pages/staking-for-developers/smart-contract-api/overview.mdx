...
* [Avalance Liquid Staking API](/staking-for-developers/smart-contract-api/avax-api/)
* [Binance Liquid Staking API](/staking-for-developers/smart-contract-api/bnb-api/)
* [Ethereum Liquid Staking API](/staking-for-developers/smart-contract-api/eth-api/)
* [Fantom Liquid Staking API](/staking-for-developers/smart-contract-api/ftm-api/)
* [Polygon Liquid Staking API](/staking-for-developers/smart-contract-api/matic-api/)