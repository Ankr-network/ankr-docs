...
* Interact with 40+ [supported blockchains](/rpc-service/chains/chains-list/).
...
<img src="/docs/build/contract-auto.png" class="responsive-pic" width="600" />
...
<img src="/docs/build/verify.png" class="responsive-pic" width="600" />
...
<div className="nx-p-4 border border-gray-200 dark:border-gray-900 rounded nx-mt-6">
    [Start with the Digital ID or inregrate with Verify](automation/overview) ↗
</div>
