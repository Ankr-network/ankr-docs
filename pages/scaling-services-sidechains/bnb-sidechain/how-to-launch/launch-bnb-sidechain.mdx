...
<Callout>
You can easily customize parameters of the genesis config file via [Genesis Configurator](/affiliated-chains/bnb-sidechain/how-to-launch/customize-genesis-config).

For the rest of the sidechain's codebase, see [the list of available BNB Sidechain repos](/affiliated-chains/bnb-sidechain/architecture/overview/#repositories).
</Callout>
