...
As Sidechains as a service are gaining adoption and popularity, we are partnering with other similar ecosystems to extend their functionality and improve your experience as a client.

Today, as an official Polygon Supernets partner, we are offering critical infrastructure for building on Polygon Supernets. 

With Ankr's Sidechains as a service, you'll gain access to your own Supernet network that is ready to be interoperable with Polygon mainnet right out of the box.

## Reasons to use Sidechains as a service for your Supernet
